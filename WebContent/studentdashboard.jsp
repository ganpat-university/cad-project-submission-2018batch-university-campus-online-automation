                    ...
                    <div class="col-md-12">
                        ...
                        <div class="main-menu">
                            <ul>
                            	...
                            	<a style="color:red;">
                            	<% 
									String enno = (String)session.getAttribute("ses_name");
									//System.out.println(enno);
									out.println("Welcome&nbsp;&nbsp;"+enno);
								%>
								</a>
                            	</li>
                                ...
                                <li>
                                   <a href="demoindex.html" class="mm-arr">Logout</a>
                                </li>
                             </ul>
                        </div>
                    </div>
            ...
            <div class="container pg-inn">
                <!--div class="col-md-3">
                    <div class="pro-user-bio">
                        ...
                        <div class="udb-sec udb-cour-stat">
                            <h4><img src="images/icon/db3.png" alt="" />Visiting companies' details</h4>
                            <p>Here is the list of companies : </p>
                            <div class="pro-con-table">
                                <table class="bordered responsive-table">
                                    <thead>
                                        <tr>
                                	...
                                	Class.forName("com.mysql.jdbc.Driver");	 
						             ...
						             ResultSet rss = stmtt.executeQuery("select * from company");   
						             while (rss.next()) 
						             {  
						                 String a = rss.getString("cname");  
						                 String b = rss.getString("cemail");  
						                 String c = rss.getString("location");   
